...
# GPU-ONLY Llama 3.3 70B Instruct 4-bit
# ============================================================
#
# IMPORTANT:
...
#   python Small_4bit_llama_gpu_only.py
# ============================================================
...
OUTPUT_CSV_PATH = str(OUTPUTS_DIR / "fixed_rag_results_llama33_70b_4bit_big.csv")

# A100 80GB: try 76GiB to 78GiB.
# A100 40GB: Llama 70B 4-bit GPU-only will likely fail.
GPU_MAX_MEMORY = "78GiB"
...
def load_llama_model(local_model_path: str):
    ...
    if total_gb < 70:
        print(
            "WARNING: This GPU appears to have less than 70 GiB memory. "
            "Llama 3.3 70B 4-bit GPU-only may OOM."
        )
    ...
    print_header("Preparing GPU-only 4-bit config")
    ...
    print_header("Loading Llama model GPU-only")
