...
**Takeaway:** Adaptive has lower hallucination (Diff=-0.1102, p=0.0001***) and higher groundedness (Diff=0.0502, p=0.0875), while also improving answer relevance (Diff=1.2344, p=0.0000***).
...
**Takeaway:** Adaptive strongly improves factual reliability vs no-retrieval: hallucination drops by 0.8042 and groundedness rises by 0.6762 (both 0.0000***/0.0000***). No-retrieval remains faster on response time by 7.20s (p=0.0000***).
...
**Takeaway:** Fixed also materially outperforms no-retrieval on hallucination and groundedness (Diff=-0.6940 / 0.6261, p=0.0000***/0.0000***) and gains answer relevance by -1.2422 (p=0.0000***).
